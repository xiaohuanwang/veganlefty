...
Dubbo3 定义为面向云原生的下一代 RPC 服务框架。3.0 基于 [Dubbo 2.x](https://cn.dubbo.apache.org/zh/docsv2.7) 演进而来，在保持原有核心功能特性的同时， Dubbo3 在易用性、超大规模微服务实践、云原生基础设施适配、安全性等几大方向上进行了全面升级。
...
- 企业级微服务治理能力
  - 国内公有云厂商支持的事实标准服务框架
  - 多年企业实践经验考验，参考[用户实践案例](https://cn.dubbo.apache.org/zh/users)

### Dubbo 基本工作流程

![dubbo-rpc](https://cn.dubbo.apache.org/imgs/v3/concepts/rpc.png)
...
![arch-service-discovery](https://cn.dubbo.apache.org/imgs/architecture.png)
...
- [Dubbo 生态](https://cn.dubbo.apache.org/zh/overview/what/ecosystem)
- [Dubbo 可扩展性设计](https://cn.dubbo.apache.org/zh/overview/what/extensibility)
...
- [容器调度平台（Kubernetes）](https://cn.dubbo.apache.org/zh/overview/tasks/kubernetes/deploy-on-k8s)
